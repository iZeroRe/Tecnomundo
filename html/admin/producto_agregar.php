...
// Consultar los proveedores para el dropdown
...
// Variables para el formulario (vacías para 'agregar')
$producto = [
    'id_proveedor' => '',
    'nombre' => '',
    'marca' => '',
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="tipo_producto" name="tipo_producto" class="form-control" required>
                            <option value="" disabled <?php echo ($producto['tipo_producto'] == '') ? 'selected' : ''; ?>>Seleccione un tipo</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="id_proveedor" name="id_proveedor" class="form-control" required>
                            <option value="" disabled <?php echo ($producto['id_proveedor'] == '') ? 'selected' : ''; ?>>Seleccione un proveedor</option>
