...
<head>
    ...
    <title>Nuevo Trabajador - Sistema de Administración</title>
...
<body>
    ...
    <main class="main-content">
        ...
        if (isset($_SESSION['error_message'])) {
            ...
            echo '</div>';
            unset($_SESSION['error_message']); // Limpiamos el mensaje
        }
        ?>
        <div class="card">
            <form action="../controllers/crear_trabajador.php" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="especialidad" id="especialidad" class="form-control" placeholder="Ej. Técnico de Hardware" required>
                    </div>
                    <div class="form-group">
