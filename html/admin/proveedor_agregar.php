                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="pieza_accesorio" name="pieza_accesorio" class="form-control" required>
                            <option value="" disabled <?php echo ($pieza_accesorio == '') ? 'selected' : ''; ?>>Seleccione un tipo</option>
                    ...
                    <div class="form-group form-col-span-2">
                        ...
                        <select id="id_empresa" name="id_empresa" class="form-control" required>
                            <option value="" disabled <?php echo ($id_empresa_sel == '') ? 'selected' : ''; ?>>Seleccione una empresa</option>
